from McLiumSDK.Packet import Parser
from McLiumSDK.Packet import PacketBuilder
class McLium:
    @staticmethod
    class McProtocol:
        @staticmethod
        def EncodeString(string):
            ...
            return McLium.McProtocol.EncodeVarInt(len(string_bytes)) + string_bytes
        @staticmethod
        ...
        def DecodeString(data: bytes) -> tuple[str, int]:
            length, offset = McLium.McProtocol.DecodeVarInt(data)
        ...
        class PacketParser(Parser):
            pass
        class PacketBuilder(PacketBuilder):
            pass